          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-10 h-10 rounded-xl bg-ice-300/[0.05] border border-ice-300/10 flex items-center justify-center text-frost-400 hover:text-ice-300 hover:border-ice-300/25 hover:bg-ice-300/[0.08] transition-all"
              >
